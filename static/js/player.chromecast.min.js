...
function toHHMMSS(a){a=new Date(Math.round(100*a)/100*1E3);return("0"+a.getUTCHours()).slice(-2)+":"+("0"+a.getUTCMinutes()).slice(-2)+":"+("0"+a.getSeconds()).slice(-2)}function guessMimeType(a){-1!=a.indexOf(".mp3")?document.getElementById("mediaMimeType").selectedIndex=2:-1!=a.indexOf(".mp4")?document.getElementById("mediaMimeType").selectedIndex=1:-1!=a.indexOf(".m3u8")&&(document.getElementById("mediaMimeType").selectedIndex=0)}
